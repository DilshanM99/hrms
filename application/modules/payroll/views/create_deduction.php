...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Create Deduction</h1>
    ...
    <?php echo form_open('payroll/store_deduction', ['class' => 'space-y-4']); ?>
        <?php echo form_hidden($csrf['name'], $csrf['hash']); ?>
    ...
    <script>
        ...
        (function($) {
            $(document).ready(function() {
                ...
                console.log('create_deduction.js: Document ready, binding events.');

                // Show/hide months-section based on type selection
                $('#type').on('change', function() {
                    var selectedType = $(this).val();
                    console.log('create_deduction.js: Type changed to: ' + selectedType);
                    if (selectedType === 'variable') {
                        console.log('create_deduction.js: Showing months-section');
                        $('#months-section').show();
                    } else {
                        console.log('create_deduction.js: Hiding months-section');
                        $('#months-section').hide();
                    }
                });
                ...
                $('#select_all_months').on('change', function() {
                    console.log('create_deduction.js: Select All Months changed to: ' + this.checked);
                ...
                $('.month-checkbox').on('change', function() {
                    ...
                    console.log('create_deduction.js: Month checkbox changed, all checked: ' + allChecked);
