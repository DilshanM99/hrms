        ...
        <div class="container mx-auto px-4 py-8 pb-10">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <select name="allowance_ids[]" id="allowance_ids" multiple
                        ...
                        required aria-label="Select Allowances">
                        <?php foreach ($allowances as $allowance): ?>
                    ...
                    <div class="flex space-x-2">
                        <button type="button" id="select-all-allowances"
                            ...
                            title="Select all allowances">
                            Select All
                        </button>
                        <button type="button" id="clear-allowances"
            ...
            <div class="flex space-x-4">
                <button type="submit"
                    ...
                    title="Assign selected allowances">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
